...
@section("content")
    ...
    @include(
        "section-breadcrumb",
        [
            "breadcrumbs" => [["label" => "Profil", "url" => "/profil"], ["label" => "Struktur Organisasi"]],
        ]
    )
    ...
    <section class="bg-white dark:bg-gray-900 py-20">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid lg:grid-cols-4 gap-6">
                <!-- Sidebar Navigation -->
                @include("profil-sidebar", ["activePage" => "struktur-organisasi"])
                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg transition-all duration-300">
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <h2 class="text-3xl font-bold text-gray-800 dark:text-white">Struktur Organisasi</h2>
                        </div>
